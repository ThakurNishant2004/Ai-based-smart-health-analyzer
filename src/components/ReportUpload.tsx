  ...
  return (
    <div className="flex-1 w-full max-w-full min-w-0 bg-gray-50 overflow-auto">
      <div className="p-3 sm:p-6 w-full">
        {/* Header */}
        <div className="mb-6">
          <h1 className="text-xl sm:text-2xl md:text-3xl text-gray-900 mb-1">Health Report Upload</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
              ...
              {!uploadedFile ? (
                <label className="block">
                  ...
                  <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center hover:border-blue-400 hover:bg-blue-50/50 transition-all cursor-pointer">
                    ...
                    <p className="text-sm text-gray-500 mb-3">Maximum file size: 10MB</p>
                    <Button type="button" className="bg-blue-500 hover:bg-blue-600 w-full sm:w-auto">
                      Select File
                    </Button>
                  </div>
                </label>
              ...
              <Card className="p-3 sm:p-4 bg-white border-0 shadow-sm">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-4">
                  <div className="p-3 bg-gradient-to-br from-green-50 to-green-100 rounded-lg border border-green-200 text-center">
                    ...
                    <p className="text-xl sm:text-2xl text-green-900">6</p>
                  </div>
                  <div className="p-3 bg-gradient-to-br from-red-50 to-red-100 rounded-lg border border-red-200 text-center">
                    ...
                    <p className="text-xl sm:text-2xl text-red-900">2</p>
                  </div>
                  <div className="p-3 bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg border border-blue-200 text-center">
                    ...
                    <p className="text-xl sm:text-2xl text-blue-900">8</p>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  {mockExtractedData.map((item, index) => (
                    <div key={index} className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-3 border border-gray-200 rounded-lg hover:border-blue-300 transition-colors">
                      <div className="flex-1 min-w-0 mb-2 sm:mb-0">
                        <h4 className="text-gray-900 mb-1 break-words">{item.parameter}</h4>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <Badge variant="outline" className={getStatusColor(item.status) + ' min-w-[72px] justify-center'}>
                ...
                <div className="mt-4 flex flex-col sm:flex-row gap-3">
                  ...
                  <Button className="w-full sm:flex-1 bg-blue-500 hover:bg-blue-600">
          ...
          <div className="space-y-4">
            ...
            {/* Info Card */}
            <Card className="p-3 sm:p-4 bg-gradient-to-br from-blue-50 to-purple-50 border-0 shadow-sm">
              <div className="w-9 h-9 bg-blue-500 rounded-lg flex items-center justify-center mb-3">
                <Brain className="w-4 h-4 text-white" />
              </div>
              <h3 className="text-gray-900 mb-1">AI-Powered OCR</h3>
